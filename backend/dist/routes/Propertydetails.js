...
const Propertydetails_1 = __importDefault(require("../models/Propertydetails")); // Adjust the path to your Property model file
const PropertyLocation_1 = __importDefault(require("../models/PropertyLocation")); // Adjust the path to your PropertyLocation model file
const Propertyfeatures_1 = __importDefault(require("../models/Propertyfeatures")); // Adjust the path to your PropertyFeatures model file
const Societyamenities_1 = __importDefault(require("../models/Societyamenities"));
const Flatamenities_1 = __importDefault(require("../models/Flatamenities"));
const Propertyrestrictions_1 = __importDefault(require("../models/Propertyrestrictions"));
const Propertycommercials_1 = __importDefault(require("../models/Propertycommercials"));
const PropertyAvailability_1 = __importDefault(require("../models/PropertyAvailability"));
const PropertyPhotos_1 = __importDefault(require("../models/PropertyPhotos"));
...
propertyRouter.post("/property", async (req, res) => {
    try {
        ...
        const newProperty = new Propertydetails_1.default(req.body);
...
propertyRouter.get("/propertyds/:id", async (req, res) => {
    try {
        const { id } = req.params;
        // Find the property by ID
        const property = await Propertydetails_1.default.findById(id);
        if (!property) {
...
propertyRouter.put("/property/:id", async (req, res) => {
    try {
        ...
        const updatedProperty = await Propertydetails_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
...
propertyRouter.post("/property-location", async (req, res) => {
    try {
        const { property, flatNo, addressLine1, addressLine2, addressLine3, latitude, longitude, locality, area, pinCode, } = req.body;
        // Validate property reference
        const propertyDoc = await Propertydetails_1.default.findById(property);
        if (!propertyDoc) {
            return res.status(404).send({ error: "Property not found" });
        }
        // Create a new PropertyLocation document
        const propertyLocation = new PropertyLocation_1.default({
            property,
...
propertyRouter.get("/:propertyId/locations", async (req, res) => {
    try {
        ...
        const locations = await PropertyLocation_1.default.find({ property: propertyId });
...
propertyRouter.get("/property-location/:locationId", async (req, res) => {
    try {
        ...
        const location = await PropertyLocation_1.default.findById(locationId);
...
propertyRouter.get("/property-location", async (req, res) => {
    try {
        // Retrieve all property locations from the database
        const propertyLocations = await PropertyLocation_1.default.find().populate("property", "propertyName");
...
propertyRouter.put("/property-location/:id", async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedPropertyLocation = await PropertyLocation_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
...
propertyRouter.post("/property-features", async (req, res) => {
    try {
        const { property, bedrooms, bathrooms, balconies, extraRooms, floorNumber, totalFloors, superBuiltupArea, builtupArea, carpetArea, propertyAge, propertyDescription, } = req.body;
        // Validate property reference
        const propertyDoc = await Propertydetails_1.default.findById(property);
        if (!propertyDoc) {
            return res.status(404).send({ error: "Property not found" });
        ...
        const propertyFeatures = new Propertyfeatures_1.default({
            property,
            propertyName: propertyDoc.propertyName, // Dynamically set propertyName
            bedrooms,
            bathrooms,
...
propertyRouter.get("/:propertyId/features", async (req, res) => {
    try {
        const { propertyId } = req.params;
        // Validate propertyId
        if (!propertyId) {
        ...
        const features = await Propertyfeatures_1.default.find({ property: propertyId });
...
propertyRouter.get("/property-features/:featuresId", async (req, res) => {
    try {
        ...
        const features = await Propertyfeatures_1.default.findById(featuresId);
...
propertyRouter.get("/property-features", async (req, res) => {
    try {
        ...
        const propertyFeatures = await Propertyfeatures_1.default.find(query)
...
propertyRouter.put("/property-features/:id", async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedPropertyFeatures = await Propertyfeatures_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
        { new: true, runValidators: true } // Return the updated document and validate fields
        ).populate("property", "propertyName"); // Populate propertyName from the Property model
...
propertyRouter.post("/society-amenities", async (req, res) => {
    try {
        ...
        const societyAmenities = new Societyamenities_1.default({
            property,
            propertyName: propertyDoc.propertyName, // Dynamically set propertyName
            selectedAmenities,
            powerBackupType,
...
propertyRouter.get("/:propertyId/society-amenities", async (req, res) => {
    try {
        const { propertyId } = req.params;
        // Validate propertyId
        if (!propertyId) {
        ...
        const amenities = await Societyamenities_1.default.find({ property: propertyId });
...
propertyRouter.get("/society-amenities/:amenitiesId", async (req, res) => {
    try {
        ...
        const amenities = await Societyamenities_1.default.findById(amenitiesId);
...
//Routes get all property features
propertyRouter.get("/society-amenities", async (req, res) => {
    try {
        const { property, _id } = req.query;
        ...
        const societyAmenities = await Societyamenities_1.default.find(query)
            .populate("property", "propertyName") // Populates propertyName from the Property model
            .exec();
...
propertyRouter.put("/society-amenities/:id", async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedSocietyAmenities = await Societyamenities_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
        { new: true, runValidators: true } // Return the updated document and validate fields
        ).populate("property", "propertyName"); // Populate propertyName from the Property model
...
propertyRouter.post("/flat-amenities", async (req, res) => {
    try {
        ...
        const flatAmenities = new Flatamenities_1.default({
            property,
            propertyName: propertyDoc.propertyName, // Dynamically set propertyName
            selectedAmenities,
        });
...
propertyRouter.get("/:propertyId/flat-amenities", async (req, res) => {
    try {
        const { propertyId } = req.params;
        // Validate propertyId
        if (!propertyId) {
        ...
        const amenities = await Flatamenities_1.default.find({ property: propertyId });
        // If no amenities are found
        if (!amenities || amenities.length === 0) {
...
propertyRouter.get("/flat-amenities/:amenitiesId", async (req, res) => {
    try {
        const { amenitiesId } = req.params;
        // Validate amenitiesId
        if (!amenitiesId) {
        ...
        const amenities = await Flatamenities_1.default.findById(amenitiesId);
        // If the amenities document is not found
        if (!amenities) {
...
propertyRouter.get("/flat-amenities", async (req, res) => {
    try {
        const { property, _id } = req.query;
        // Build query based on optional filters
        const query = {};
        ...
        const flatAmenities = await Flatamenities_1.default.find(query)
            .populate("property", "propertyName") // Populates propertyName from the Property model
            .exec();
...
propertyRouter.put("/flat-amenities/:id", async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedFlatAmenities = await Flatamenities_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
        { new: true, runValidators: true } // Return the updated document and validate fields
        ).populate("property", "propertyName"); // Populate propertyName from the Property model
...
propertyRouter.post("/property-restrictions", async (req, res) => {
    try {
        const { property, bachelorTenants, nonVegTenants, tenantWithPets, propertyOverlooking, carParking, carParkingCount, twoWheelerParking, twoWheelerParkingCount, flooringType, } = req.body;
        // Validate property reference
        const propertyDoc = await Propertydetails_1.default.findById(property);
        if (!propertyDoc) {
            return res.status(404).send({ error: "Property not found" });
        ...
        const propertyRestrictions = new Propertyrestrictions_1.default({
            property,
            propertyName: propertyDoc.propertyName, // Dynamically set propertyName
            bachelorTenants,
            nonVegTenants,
...
propertyRouter.get("/:propertyId/restrictions", async (req, res) => {
    try {
        const { propertyId } = req.params;
        // Validate propertyId
        if (!propertyId) {
        ...
        const restrictions = await Propertyrestrictions_1.default.find({ property: propertyId });
...
propertyRouter.get("/property-restrictions", async (req, res) => {
    try {
        const { property, _id } = req.query;
        // Build query based on optional filters
        const query = {};
        ...
        const propertyRestrictions = await Propertyrestrictions_1.default.find(query)
            .populate("property", "propertyName") // Populates propertyName from the Property model
            .exec();
...
propertyRouter.get("/property-restrictions/:restrictionsId", async (req, res) => {
    try {
        ...
        const restrictions = await Propertyrestrictions_1.default.findById(restrictionsId);
...
propertyRouter.put("/property-restrictions/:id", async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedPropertyRestrictions = await Propertyrestrictions_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
        { new: true, runValidators: true } // Return the updated document and validate fields
        ).populate("property", "propertyName"); // Populate propertyName from the Property model
...
propertyRouter.post("/property-commercials", async (req, res) => {
    try {
        ...
        const propertyCommercials = new Propertycommercials_1.default({
            property,
            propertyName: propertyDoc.propertyName, // Dynamically set propertyName
            monthlyRent,
            maintenance,
...
propertyRouter.get("/property-commercials", async (req, res) => {
    try {
        const { property, _id } = req.query;
        // Build query based on optional filters
        const query = {};
        ...
        const propertyCommercials = await Propertycommercials_1.default.find(query)
            .populate("property", "propertyName") // Populate propertyName from the Property model
            .exec();
...
propertyRouter.get("/:propertyId/commercials", async (req, res) => {
    try {
        const { propertyId } = req.params;
        // Validate propertyId
        if (!propertyId) {
        ...
        const commercials = await Propertycommercials_1.default.find({ property: propertyId });
...
propertyRouter.get("/property-commercials/:commercialsId", async (req, res) => {
    try {
        ...
        const commercials = await Propertycommercials_1.default.findById(commercialsId);
...
propertyRouter.put("/property-commercials/:id", async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedPropertyCommercials = await Propertycommercials_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
        { new: true, runValidators: true } // Return the updated document and validate fields
        ).populate("property", "propertyName"); // Populate propertyName from the Property model
...
propertyRouter.post("/property-availability", async (req, res) => {
    try {
        ...
        const propertyAvailability = new PropertyAvailability_1.default({
            property,
            propertyName: propertyDoc.propertyName, // Dynamically set propertyName
            availableFrom,
        });
...
propertyRouter.get("/:propertyId/availability", async (req, res) => {
    try {
        const { propertyId } = req.params;
        // Validate propertyId
        if (!propertyId) {
        ...
        const availability = await PropertyAvailability_1.default.find({ property: propertyId });
...
propertyRouter.get("/property-availability/:availabilityId", async (req, res) => {
    try {
        ...
        const availability = await PropertyAvailability_1.default.findById(availabilityId);
...
propertyRouter.get("/property-details/:propertyId", async (req, res) => {
    const { propertyId } = req.params;
    try {
        ...
        const propertyLocation = await PropertyLocation_1.default.findOne({ property: propertyId });
        const propertyFeatures = await Propertyfeatures_1.default.findOne({ property: propertyId });
        const societyAmenities = await Societyamenities_1.default.findOne({ property: propertyId });
        const flatAmenities = await Flatamenities_1.default.findOne({ property: propertyId });
        const propertyRestrictions = await Propertyrestrictions_1.default.findOne({ property: propertyId });
        const propertyCommercials = await Propertycommercials_1.default.findOne({ property: propertyId });
        const propertyAvailability = await PropertyAvailability_1.default.findOne({ property: propertyId });
        const propertyPhotos = await PropertyPhotos_1.default.findOne({ property: propertyId }); // Fetch property photos
...
propertyRouter.get("/property-availability", async (req, res) => {
    try {
        const { property, _id } = req.query;
        // Build query filters dynamically
        const query = {};
        if (property)
            query.property = property; // Filter by property ID
        if (_id)
            query._id = _id; // Filter by specific availability document ID
        // Fetch property availability data
        const propertyAvailability = await PropertyAvailability_1.default.find(query)
            .populate("property", "propertyName") // Populates propertyName from the Property model
            .exec();
        // If no records found
...
propertyRouter.put("/property-availability/:id", async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedPropertyAvailability = await PropertyAvailability_1.default.findByIdAndUpdate(id, req.body, // Updates from the request body
        { new: true, runValidators: true } // Return the updated document and validate fields
        ).populate("property", "propertyName"); // Populate propertyName from the Property model
